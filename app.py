...
.game-title { font-size: 1.2rem; font-weight: 800; margin-bottom: 4px; }
.game-desc { font-size: 0.8rem; color: #555; }
.game-stats { font-size: 0.75rem; margin-top: 8px; font-weight: 600; }

/* Hero */
.hero { text-align: center; padding: 24px 0 16px 0; }
.hero-title {
...
.hero-sub { font-size: 0.9rem; color: #444; margin-top: 4px; }
...
if st.session_state.page == "home":
    ...
    with col1:
        ...
        <div class="game-card" style="border-color:#6366f133;">
            ...
            <div class="game-stats" style="color:#6366f1;">108 questions · 20 per game</div>
    ...
    with col2:
        ...
        <div class="game-card" style="border-color:#4ade8033;">
            ...
            <div class="game-stats" style="color:#4ade80;">51 questions · 20 per game</div>
        </div>''', unsafe_allow_html=True)
    ...
    with col1:
        ...
        <div class="game-card" style="border-color:#ec489933;">
            ...
            <div class="game-stats" style="color:#ec4899;">115 cards · 20 per session</div>
        </div>''', unsafe_allow_html=True)
    ...
    with col2:
        ...
        <div class="game-card" style="border-color:#f59e0b33;">
            ...
            <div class="game-stats" style="color:#f59e0b;">117 words · 10 per game</div>
        </div>''', unsafe_allow_html=True)
