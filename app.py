...
if st.session_state.page == "home":
    ...
    # CSS — position button absolutely over the card
    st.markdown('''<style>
.gc { position: relative; margin-bottom: 16px; }
.gc button[kind="secondary"] {
    ...
    with col1:
        st.markdown(f'''<div class="gc">
          <div class="game-card game-card-dq">
            ...
            <div class="top-scorer-pill" style="color:#6366f1;margin-top:10px;">{dq_best}</div>
          </div>''', unsafe_allow_html=True)
        if st.button("▶", key="go_dq", use_container_width=True):
    ...
    with col2:
        st.markdown(f'''<div class="gc">
          <div class="game-card game-card-pq">
            ...
            <div class="top-scorer-pill" style="color:#4ade80;margin-top:10px;">{pq_best}</div>
          </div>''', unsafe_allow_html=True)
        if st.button("▶", key="go_pq", use_container_width=True):
    ...
    with col1:
        st.markdown(f'''<div class="gc">
          <div class="game-card game-card-fk">
            ...
            <div class="top-scorer-pill" style="color:#ec4899;margin-top:10px;">{dq_best}</div>
          </div>''', unsafe_allow_html=True)
        if st.button("▶", key="go_fk", use_container_width=True):
    ...
    with col2:
        st.markdown(f'''<div class="gc">
          <div class="game-card game-card-sk">
            ...
            <div class="top-scorer-pill" style="color:#f59e0b;margin-top:10px;">{sk_best}</div>
          </div>''', unsafe_allow_html=True)
        if st.button("▶", key="go_sk", use_container_width=True):
